...
string sConnectionDP = getDriverConnectionDp(sDeviceKey, TRUE); //with starting "_"
  ...
  protected void beforeUpdateDeviceDP(const string &sDeviceKey, mapping &mParams)
  {
    ...
    int deviceID;
DebugN("BACnet DEBUG:",
       "sDeviceKey =", sDeviceKey,
       "getDeviceIndex =", getDeviceIndex(sDeviceKey),
       "getDeviceId =", getDeviceId(sDeviceKey),
       "sConnectionDP =", getDriverConnectionDp(sDeviceKey));
    dpGet(sConnectionDP + ".DeviceId", deviceID);
int deviceID;
int iRet = dpGet(getDriverConnectionDp(sDeviceKey) + ".DeviceId", deviceID);

DebugN("BACnet DEBUG RESULT:",
       "dp path =", getDriverConnectionDp(sDeviceKey) + ".DeviceId",
       "deviceID =", deviceID,
       "dpGet ret =", iRet);
